...
public class BasketballActivePageFragment extends Fragment{
	
	@Override
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		View view = (View) inflater.inflate(R.layout.fragment_active_basketball, container, false);
        return view;
	}	
	...
	private OnClickListener swapPageListener = new OnClickListener(){
		...
		public void onClick(View v) {
			...
			((BasketballSubstitutionActivity)getActivity()).setPlayerOut(((TextView)v).getText().toString());
		}
	};
